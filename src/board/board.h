...
/*
 * Setup for STM32F401CCU6 (Black Pill / WeAct).
 */

/*
 * Board identifier.
 */
#define BOARD_STM32F401_CCU6
#define BOARD_NAME    "STM32F401CCU6 Black Pill"
 ...
 * GPIOA setup:
 *
 * PA0  - BUTTON                    (input pulldown, wire button to 3V3).
 ...
 * PA9  - PIN9 (VBUS on BlackPill)  (input floating).
