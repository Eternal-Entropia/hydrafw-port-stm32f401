...
/* ADC2 -> PB.0 (ADC1_IN8) */
#define BSP_ADC2_PORT         GPIOB
#define BSP_ADC2_PIN          GPIO_PIN_0
#define BSP_ADC2_CHAN         ADC_CHANNEL_8

/* ADC3 -> PB.1 (ADC1_IN9) */
#define BSP_ADC3_PORT         GPIOB
#define BSP_ADC3_PIN          GPIO_PIN_1
#define BSP_ADC3_CHAN         ADC_CHANNEL_9
